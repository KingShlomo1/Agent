  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #page-login {
      ...
      position: relative;
      overflow: hidden;
      background: radial-gradient(ellipse at 20% 50%, #0d2a4a 0%, transparent 60%),
                  radial-gradient(ellipse at 80% 20%, #1a1040 0%, transparent 55%),
                  radial-gradient(ellipse at 60% 80%, #0a2e2a 0%, transparent 50%),
                  #080c14;
    }
    ...
    .orb-1 { width: 520px; height: 520px; background: #1e40af; top: -140px; left: -120px; animation-delay: 0s; }
    .orb-2 { width: 400px; height: 400px; background: #7c3aed; bottom: -100px; right: -80px; animation-delay: -6s; }
    .orb-3 { width: 300px; height: 300px; background: #0891b2; bottom: 30%; left: 10%; animation-delay: -12s; }
    .orb-4 { width: 250px; height: 250px; background: #065f46; top: 25%; right: 15%; animation-delay: -9s; }
  ...
  <div class="login-card">
    ...
    <div class="dest-strip-wrap">
      <div class="dest-strip" id="dest-strip">
        ...
        <div class="dest-card dc-4">Marrakech<span>Morocco</span></div>
        <div class="dest-card dc-5">New York<span>United States</span></div>
